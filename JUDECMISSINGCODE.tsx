...
// Note: Scorecard component temporarily commented out for standalone test
// import Scorecard from "@/components/sos2a/scorecard";
        ...
        <CardContent className="space-y-6">
          <Tabs defaultValue="executive-summary" className="w-full">
            ...
            <TabsContent value="scorecard" className="space-y-4">
              ...
              {/* Visual Scorecard - 5 Pillar Framework */}
              <Card>
                <CardHeader>
                  ...
                  <div className="space-y-3">
                    <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
                      <div className="text-center p-3 bg-blue-50 rounded-lg">
                        ...
                        <div className="text-xs font-medium">Qualitative Assessment</div>
                      ...
                      <div className="text-center p-3 bg-gray-50 rounded-lg opacity-50">
                        ...
                        <div className="text-xs font-medium">Quantitative Analysis</div>
                        <div className="text-xs text-muted-foreground">Weight: 25%</div>
                      </div>
                      <div className="text-center p-3 bg-gray-50 rounded-lg opacity-50">
                        <div className="text-2xl font-bold text-gray-400">0%</div>
                        <div className="text-xs font-medium">RASBITA Cost-Benefit</div>
                        <div className="text-xs text-muted-foreground">Weight: 25%</div>
                      </div>
                      <div className="text-center p-3 bg-green-50 rounded-lg">
                        <div className="text-2xl font-bold text-green-600">65%</div>
                        <div className="text-xs font-medium">RASBITA Governance</div>
                        <div className="text-xs text-muted-foreground">Weight: 15%</div>
                      </div>
                      <div className="text-center p-3 bg-orange-50 rounded-lg">
                        <div className="text-2xl font-bold text-orange-600">50%</div>
                        <div className="text-xs font-medium">Architecture Threat Modeling</div>
                        <div className="text-xs text-muted-foreground">Weight: 15%</div>
                      </div>
                    </div>
                    <div className="text-center pt-4 border-t">
                      <div className="text-3xl font-bold text-primary">500%</div>
                      <div className="text-sm text-muted-foreground">Total Framework Capacity (500% ÷ 5 = 100% each pillar)</div>
                    </div>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div>
                    ...
                    <ul className="text-sm space-y-1 ml-4 list-disc">
                      <li><strong>Employee Training:</strong> Comprehensive cybersecurity awareness programs</li>
                      <li><strong>Technical Controls:</strong> Deploy advanced endpoint protection and network monitoring</li>
                      <li><strong>Incident Response:</strong> Establish clear procedures for rapid threat response</li>
                      <li><strong>Access Controls:</strong> Implement role-based access and multi-factor authentication</li>
                    </ul>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className="text-sm space-y-1 ml-4 list-disc">
                      <li>Prioritize high-risk vulnerabilities for immediate remediation</li>
                      <li>Establish regular security assessments and compliance audits</li>
                      <li>Create incident response playbooks for common threat scenarios</li>
                      <li>Implement continuous monitoring for real-time threat detection</li>
                    </ul>
                  </div>
                </CardContent>
              </Card>
