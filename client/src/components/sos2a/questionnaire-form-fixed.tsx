...
export default function QuestionnaireForm({ onSubmit, selectedTab }: QuestionnaireFormProps) {
  ...
  const form = useForm<Sos2aFormData>({
    ...
    defaultValues: {
      ...
      // Identity Behavior and Hygiene section
      identityBehaviorHygiene: {
        selectedIdentityType: 'Machine',
        machineType: 'cloud',
        selectedIdentificationMethod: '',
        userId: '',
        fullNameRole: '',
        biometricAuthentication: false,
        biometricTypes: [],
        loginPatterns: '',
        remoteAccessFrequency: '',
        sessionDuration: '',
        abnormalAccessDetection: false,
        locationBasedAccess: false,
        identityProtectionTraining: false,
        trainingCompletionDate: '',
        phishingAwarenessLevel: '',
        securityIncidentHistory: false,
        incidentDetails: '',
        privilegedAccountInventory: false,
        justInTimeAccess: false,
        privilegeEscalationControls: false,
        adminAccountReview: '',
        separationOfDuties: '',
        onboardingStatus: '',
        onboardingOffboardingDate: '',
        offboardingProcess: false,
        accountDormancyMonitoring: false,
        ...
        mfaMethod: '',
        passwordHygiene: '',
        breachedCredentialChecks: false,
                                    ...
                                    {form.watch('identityBehaviorHygiene.machineType') === 'cloud' && (
                                      <div className="px-2 py-1.5 bg-blue-50 border border-blue-100 rounded text-xs mb-2">
                                        ...
                                        <div className="mt-1.5 text-blue-700 flex items-center text-[10px]">
                                          <Info className="h-3 w-3 mr-1" /> Uses same InstanceUUID component for all virtual machines
                                        </div>
                                      </div>
                                    )}
