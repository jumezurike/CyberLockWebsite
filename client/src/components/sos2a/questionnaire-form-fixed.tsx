        ...
        <Form {...form}>
          <form onSubmit={handleSubmit} className="space-y-8">
            <Tabs defaultValue="business" className="w-full">
              ...
              <TabsList className="grid grid-cols-4 mb-6">
                <TabsTrigger value="device-inventory-bulk">12b. Device Inventory Bulk</TabsTrigger>
              ...
              <TabsContent value="device-inventory-bulk" className="space-y-6">
                <div className="border rounded-md p-4">
                  <h3 className="font-medium mb-4">12b. Device Inventory Bulk</h3>
                  <p className="text-sm text-muted-foreground mb-4">
                    Track and manage your organization's devices to improve security visibility and control.
                  </p>
                  ...
                  <div className="mb-4">
                    <Label htmlFor="deviceTypeFilter" className="mb-2 block">Filter by Device Type</Label>
                    <Select 
                      value={deviceTypeFilter}
                      onValueChange={handleFilterChange}
                    >
                      <SelectTrigger id="deviceTypeFilter" className="w-[250px] border-purple-300 focus:ring-purple-500">
                      ...
                      <SelectContent>
                        ...
                        <SelectGroup>
                          ...
                          <SelectItem value="therapeutic">Therapeutic Equipment</SelectItem>
                          <SelectItem value="lab-equipment">Lab Equipment</SelectItem>
                        </SelectGroup>
                        <SelectGroup>
                          <SelectLabel>IT Equipment</SelectLabel>
                        ...
                        <SelectGroup>
                          <SelectLabel>IoT/Other</SelectLabel>
                          <SelectItem value="iot-sensor">IoT Sensor</SelectItem>
                          <SelectItem value="building-system">Building System</SelectItem>
                          <SelectItem value="other">Other</SelectItem>
                        </SelectGroup>
                      </SelectContent>
                    </Select>
                        ...
                        <div className="bg-gray-50 p-4 rounded-md">
                          {(field.value || []).length === 0 ? (
                            <div className="text-center p-6 border border-dashed rounded-md">
                              <p className="text-gray-500 mb-2">No devices added yet</p>
                              <Button
                                type="button"
                                variant="outline"
                                onClick={addDevice}
                              ...
                              <table className="w-full border-collapse">
                                <thead>
                                  <tr className="bg-gray-100">
                                    <th className="px-4 py-2 text-left border">Device Type</th>
                                    <th className="px-4 py-2 text-left border">Make/Model</th>
                                    <th className="px-4 py-2 text-left border">Serial Number</th>
                                    <th className="px-4 py-2 text-left border">Operating System</th>
                                    <th className="px-4 py-2 text-left border">Network Zone</th>
                                    <th className="px-4 py-2 text-left border">Status</th>
                                    <th className="px-4 py-2 text-left border">Action</th>
                                  </tr>
                                </thead>
                                <tbody>
                                  {(deviceTypeFilter === 'all' ? field.value || [] : 
                                    (field.value || []).filter(d => d.deviceType === deviceTypeFilter)
                                  ).map((device, index) => (
                                    <tr key={device.id || index} className="border">
                                      <td className="px-4 py-2 border">{device.deviceType}</td>
                                      <td className="px-4 py-2 border">{device.makeModel}</td>
                                      <td className="px-4 py-2 border">{device.serialNumber}</td>
                                      <td className="px-4 py-2 border">{device.operatingSystem}</td>
                                      <td className="px-4 py-2 border">{device.networkZone}</td>
                                      <td className="px-4 py-2 border">
                                        <Badge 
                                          variant={device.patchStatus === 'Up to date' ? 'outline' : 'destructive'}
                                          className={device.patchStatus === 'Up to date' ? 'bg-green-100 text-green-800 hover:bg-green-100' : ''}
                                        >
