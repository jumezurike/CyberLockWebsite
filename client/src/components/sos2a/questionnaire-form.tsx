          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            <Tabs defaultValue="business" className="w-full">
              <TabsList className="flex flex-wrap mb-4 overflow-x-auto">
                ...
                <TabsTrigger value="compliance" className="flex-shrink-0">5. Compliance Requirements</TabsTrigger>
                ...
                <TabsTrigger value="questionnaires" className="flex-shrink-0">8. Relevant ACQ Tools</TabsTrigger>
                ...
                <TabsTrigger value="review" className="flex-shrink-0">12. Review & Submit</TabsTrigger>
              </TabsList>
