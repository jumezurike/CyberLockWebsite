...
import { AlertCircle, UserPlus, FileDown, Eye, Copy, Trash, RefreshCw, HelpCircle, Server, CloudCog, Cpu, Monitor } from "lucide-react";

export function Section13Complete({ form }: { form: any }) {
  return (
    <div className="space-y-6">
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Textarea 
                    placeholder="List systems and resources this identity can access"
                    {...field}
                  />
                </FormControl>
                <FormMessage />
      ...
      <div className="border rounded-md p-4 mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <FormField
            control={form.control}
            name="identityBehaviorHygiene.passwordPolicy"
            render={({ field }) => (
              <FormItem>
          ...
          <FormField
            control={form.control}
            name="identityBehaviorHygiene.lastPasswordChange"
            render={({ field }) => (
              <FormItem>
      ...
      <div className="border rounded-md p-4 mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <FormField
            control={form.control}
            name="identityBehaviorHygiene.privilegedAccount"
            render={({ field }) => (
              <FormItem className="flex flex-row items-start space-x-3 space-y-0 border p-4 rounded-md">
                ...
                <div className="space-y-1 leading-none">
                  <FormLabel>Privileged Account</FormLabel>
                  <FormDescription>
                    Is this a privileged account with elevated permissions?
                  </FormDescription>
                </div>
              </FormItem>
            )}
      ...
      <div className="border rounded-md p-4 mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <FormField
            control={form.control}
            name="identityBehaviorHygiene.employmentStatus"
            render={({ field }) => (
              <FormItem>
          ...
          <FormField
            control={form.control}
            name="identityBehaviorHygiene.lastSecurityTraining"
            render={({ field }) => (
              <FormItem>
                <FormLabel>Last Security Training</FormLabel>
                <FormControl>
                  <Input type="date" {...field} />
                </FormControl>
                <FormMessage />
      ...
      {/* 7. Behavior Monitoring Section */}
      <div className="border rounded-md p-4 mb-6">
        <h4 className="font-medium mb-4">7. Behavior Monitoring</h4>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <FormField
            control={form.control}
            name="identityBehaviorHygiene.loginAnomaly"
            render={({ field }) => (
              <FormItem>
                <FormLabel>Login Anomaly Detection</FormLabel>
                <Select onValueChange={field.onChange} defaultValue={field.value}>
                  <FormControl>
                    <SelectTrigger>
          ...
          <FormField
            control={form.control}
            name="identityBehaviorHygiene.typicalLoginHours"
            render={({ field }) => (
              <FormItem>
                <FormLabel>Typical Login Hours</FormLabel>
                <FormControl>
                  <Input placeholder="e.g., 9:00-17:00" {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
      ...
      {/* UWA Records Table - OPTIONAL */}
      <div className="border rounded-md p-4 mb-6 bg-muted/5">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2">
            <h4 className="font-medium">UWA Records Table</h4>
            <Badge variant="secondary" className="text-xs">OPTIONAL</Badge>
          </div>
        </div>
        <p className="text-xs text-muted-foreground mb-4">
          This is not required to complete the assessment and proceed to the next section. 
          UWA Records provide enhanced identity tracking capabilities for organizations that need detailed identity management.
        </p>
        ...
        <div className="overflow-x-auto">
          <Table>
            <TableHeader>
              <TableRow>
                <TableHead className="text-xs">UWA</TableHead>
                <TableHead className="text-xs">DNA</TableHead>
                <TableHead className="text-xs">Identity Type</TableHead>
                <TableHead className="text-xs">Google Location</TableHead>
                <TableHead className="text-xs">SERVER/OWNER/COMPANY</TableHead>
                <TableHead className="text-xs">Actions</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              <TableRow>
                <TableCell className="text-xs text-muted-foreground">No UWA records generated yet</TableCell>
