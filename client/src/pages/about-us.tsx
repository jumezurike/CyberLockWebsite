          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Card className="border-primary/10 shadow-md overflow-hidden">
              ...
              <CardContent className="space-y-4">
                ...
                <a 
                  href="https://www.linkedin.com/in/drgeorgiabailey/" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="inline-flex items-center text-primary hover:text-primary/80"
                >
        ...
        <div className="mb-16">
          <div className="text-center mb-12">
            <div className="flex items-center justify-center mb-3">
              ...
              <h2 className="text-3xl font-bold text-gray-900">Advisory Team</h2>
            </div>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Strategic advisors and healthcare professionals guiding our security solutions
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
            ...
            <Card className="border-primary/10 shadow-md overflow-hidden">
              ...
              <CardContent className="space-y-4">
                <p className="text-gray-700">
                  Mike brings extensive software development and business leadership experience at an enterprise level to CyberLockX. 
            ...
            <Card className="border-primary/10 shadow-md overflow-hidden">
              ...
              <CardContent className="space-y-4">
                <p className="text-gray-700">
                  Christopher brings his extensive financial expertise and leadership experience to CyberLockX. 
                  With an MBA and MSE background, he provides strategic financial guidance and business development insights, 
