// COMPLETE DEVICE INVENTORY BACKUP - 2025-06-03
// Full Tab Content from lines 3645-4513 in questionnaire-form.tsx
            ...
            render={({ field }) => (
              <FormItem className="flex flex-row items-start space-x-3 space-y-0 border p-4 rounded-md">
                ...
                <div className="space-y-1 leading-none">
                  ...
                  <FormDescription>
                    Check if device uses VPN or is enrolled in MDM
                  </FormDescription>
                </div>
              </FormItem>
            )}
